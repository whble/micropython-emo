...
#define USBD_MANUFACTURER_STRING      "EmoRobots"
#define USBD_PRODUCT_HS_STRING        "Emoboard Virtual Comm Port in HS Mode"
#define USBD_PRODUCT_FS_STRING        "Emoboard Virtual Comm Port in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "Emoboard Config"
#define USBD_INTERFACE_HS_STRING      "Emoboard Interface"
#define USBD_CONFIGURATION_FS_STRING  "Emoboard Config"
#define USBD_INTERFACE_FS_STRING      "Emoboard Interface"
